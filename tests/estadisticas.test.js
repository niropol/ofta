...
function nom(cat, precio) { return app.crearPrestacion({ categoria: cat, descripcion: cat, precio, vigenciaDesde: '2026-01-01' }); }

describe('Estadísticas — resumen del mes', () => {
  it('cuenta prestaciones, consultas y por categoría; ingresos/egresos de caja', () => {
    const c = nom('consulta', 11000); const faco = nom('cirugia', 500000);
    ...
    expect(r.honorariosCalc).toBe(222000); // 200000 (40% cirugía) + 22000 (2 consultas ×11000)
  });
